 ...
 *
 * Tit For Tat For Unknown Number of Rounds With Probability Strategy
 *
 * Authors:
...
public class TitForTatForUnknownNumRoundsWithProbabilityStrategy extends Strategy {
     ...
     * the Tit For Tat For Unknown Number of Rounds With Probability Strategy's Common Utils,
     * it was initialized or not.
     */
    private boolean isMyTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtilsInitialized;

    /**
     * The Tit For Tat For Unknown Number of Rounds With Probability Strategy's Common Utils.
     */
    private TitForTatStrategyCommonUtils myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils;


    // Public Methods/Procedures:

    /**
     * Executes the Tit For Tat For Unknown Number of Rounds With Probability Strategy,
    ...
    public void execute() throws InterruptedException {
        ...
        while(true) {
            ...
            if( !this.isMyTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtilsInitialized) {

                this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils =
                        new TitForTatStrategyCommonUtils(myTitForTatStrategy);

                this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.setupTitForTatStrategyParametersConfiguration();

                this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.printTitForTatStrategyParametersConfiguration();

                this.isMyTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtilsInitialized = true;
            ...
            while( !playComplete ) {
                ...
                this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.setNumOfGameStagesRoundsCurrentlyPlayed
                        (
                                this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() + 1
                        );
     ...
     *
     * @param myTitForTatForUnknownNumRoundsWithProbabilityStrategy
     *        the Tit For Tat For Unknown Number of Rounds With Probability Strategy
    ...
    private void computeTitForTatStrategy
            (
                    List<GameNode> listOfOpponentLastMovesAsPlayer1,
                    List<GameNode> listOfOpponentLastMovesAsPlayer2,
                    PlayStrategy myTitForTatForUnknownNumRoundsWithProbabilityStrategy
            )
            throws GameNodeDoesNotExistException
    {
        ...
        if( gainFromDefect > probabilisticLossFromDefect ) {
            ...
            myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
            myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
            ...
            myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
            myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
        ...
        // so can be more benefit to, maybe, play a Cooperate Move, acting as both, Players #1 and #2
            ...
            for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                    ...
                    if( ( this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils
                            ...
                            ( this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() == 1 ) )
                    {
                        ...
                        this.myTitForTatForUnknownNumRoundsWithProbabilityStrategyCommonUtils.setMyOpponentMovePlayedInLastGameStageRoundAsPlayer1
                                (
                    ...
                    if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                        myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                    ...
                    if( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                        myTitForTatForUnknownNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
