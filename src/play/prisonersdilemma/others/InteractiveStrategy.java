package play.prisonersdilemma.others;
	...
	public void execute() throws InterruptedException {
		...
		while(true) {
			...
			while(! playComplete ) {
                ...
                PrisonersDilemmaStrategyCommonUtils.isATerminalGameNode(myStrategy, this.tree.getNodeByIndex(myStrategy.getFinalP1Node()), this.tree.getNodeByIndex(myStrategy.getFinalP2Node()));
