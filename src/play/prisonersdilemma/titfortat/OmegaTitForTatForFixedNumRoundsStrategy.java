...
public class OmegaTitForTatForFixedNumRoundsStrategy extends Strategy {
     ...
     * the Omega Tit For Tat Strategy For Fixed Number of Rounds' Common Utils, it was initialized or not.
     */
    private boolean isMyOmegaTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized;

    /**
     * The Omega Tit For Tat Strategy For Fixed Number of Rounds' Common Utils.
     */
    private OmegaTitForTatStrategyCommonUtils myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils;


    // Public Methods/Procedures:

    /**
     * Executes the Omega Tit For Tat Strategy For Fixed Number of Rounds, for the current Game being played.
     *
    ...
    public void execute() throws InterruptedException {
        ...
        boolean isMyOmegaTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized = false;
        ...
        while(true) {
            ...
            if( !this.isMyOmegaTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized) {


                this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils =
                        new OmegaTitForTatStrategyCommonUtils(myOmegaTitForTatStrategy);

                this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.setupOmegaTitForTatStrategyParametersConfiguration();

                this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.printOmegaTitForTatStrategyParametersConfiguration();

                this.isMyOmegaTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized = true;
            ...
            while( !playComplete ) {
                ...
                this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.setNumOfGameStagesRoundsCurrentlyPlayed
                        (
                                this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() + 1
                        );
     ...
     *
     * @param myOmegaTitForTatForFixedNumRoundsStrategy
     *        the Omega Tit For Tat For Fixed Number of Rounds Strategy I'm currently using, with my moves
     *
    ...
    private void computeOmegaTitForTatStrategy
            (
                    List<GameNode> listOfOpponentLastMovesAsPlayer1,
                    List<GameNode> listOfOpponentLastMovesAsPlayer2,
                    PlayStrategy myOmegaTitForTatForFixedNumRoundsStrategy
            )
            throws GameNodeDoesNotExistException
    {
        ...
        if(gainFromDefect > deterministicLossFromDefect) {
            ...
            myOmegaTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
            myOmegaTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
            ...
            myOmegaTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
            myOmegaTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
        ...
        // so can be more benefit to, maybe, play a Cooperate Move, acting as both, Players #1 and #2
            ...
            for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                    ...
                    if( ( this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils
                        ...
                        ( this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() == 1 ) )
                    {
                        ...
                        this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.setMyOpponentMovePlayedInLastGameStageRoundAsPlayer1
                                (
                                       ...
                                       .equalsIgnoreCase( myOpponentMoveInLastGameStageRoundParts[2].toUpperCase() ) ) )
                        {
                            ...
                            this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.setTotalNumOfTimesMyOpponentMovesChangedAsPlayer1
                                    (
                                        this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils
                    ...
                    this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.checkIfMyOpponentIsBehavingRandomAsPayer1();
                    ...
                    if( this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer1() ) {
                    ...
                    // with a general and well known, Tit For Tat Strategy
                        ...
                        if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                            ...
                            // Setting My Strategy, accordingly to the previously mentioned description
                            myOmegaTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                            myOmegaTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                    ...
                    if ((this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils
                        ...
                        if ((!this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils
                            ...
                            this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.setTotalNumOfTimesMyOpponentMovesChangedAsPlayer2
                                    (
                                            this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils
                    ...
                    this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.checkIfMyOpponentIsBehavingRandomAsPayer2();

                    // It seems that My Opponent behaved randomly as Player #2, until now,
                    // so I will act severely and I am gonna punish him always from now,
                    // with an All Defect Strategy, as Player #1
                    if (this.myOmegaTitForTatForFixedNumRoundsStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer2()) {
                    ...
                    // with a general and well known, Tit For Tat Strategy, as Player #1
                        ...
                        if (myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE)) {
                            ...
                            // Setting My Strategy, accordingly to the previously mentioned description
                            myOmegaTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                            myOmegaTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
