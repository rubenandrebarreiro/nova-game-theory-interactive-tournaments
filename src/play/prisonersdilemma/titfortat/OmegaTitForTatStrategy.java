    ...
    public void execute() throws InterruptedException {
        ...
        while(true) {
            ...
            if( !this.isMyOmegaTitForTatStrategyCommonUtilsInitialized ) {
                ...
                this.myOmegaTitForTatStrategyCommonUtils.setupOmegaTitForTatStrategyParametersConfiguration();

                this.myOmegaTitForTatStrategyCommonUtils.printOmegaTitForTatStrategyParametersConfiguration();
        ...
        for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
            ...
            if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                ...
                if( this.myOmegaTitForTatStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer1() ) {
                    ...
                    myOmegaTitForTatStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
                    myOmegaTitForTatStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
                ...
                // with a general and well known, Tit For Tat Strategy
                    ...
                    if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myOmegaTitForTatStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                        myOmegaTitForTatStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
            ...
            if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                ...
                if( this.myOmegaTitForTatStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer2() ) {
                    ...
                    // Setting My Strategy, accordingly to the previously mentioned description
                    myOmegaTitForTatStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
                    myOmegaTitForTatStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
                ...
                // with a general and well known, Tit For Tat Strategy, as Player #1
                    ...
                    if( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myOmegaTitForTatStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                        myOmegaTitForTatStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
