 ...
 *
 * Tit For Tat For Fixed Number of Rounds Strategy
 *
 * Authors:
...
public class TitForTatForFixedNumRoundsStrategy extends Strategy {
     ...
     * the Tit For Tat For Fixed Number of Rounds Strategy's Common Utils, it was initialized or not.
     */
    private boolean isMyTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized;

    /**
     * The Tit For Tat For Fixed Number of Rounds Strategy's Common Utils.
     */
    private TitForTatStrategyCommonUtils myTitForTatForFixedNumRoundsStrategyCommonUtils;


    // Public Methods/Procedures:

    /**
     * Executes the Tit For Tat For Fixed Number of Rounds Strategy, for the current Game being played.
     *
    ...
    public void execute() throws InterruptedException {
        ...
        System.out.println("Start playing with the Tit For Tat For Fixed Number of Rounds Strategy...\n\n");
        ...
        while(true) {
            ...
            if( !this.isMyTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized) {

                this.myTitForTatForFixedNumRoundsStrategyCommonUtils =
                        new TitForTatStrategyCommonUtils(myTitForTatStrategy);

                this.myTitForTatForFixedNumRoundsStrategyCommonUtils.setupTitForTatStrategyParametersConfiguration();

                this.myTitForTatForFixedNumRoundsStrategyCommonUtils.printTitForTatStrategyParametersConfiguration();

                this.isMyTitForTatForFixedNumRoundsStrategyCommonUtilsInitialized = true;
            ...
            while( !playComplete ) {
                ...
                this.myTitForTatForFixedNumRoundsStrategyCommonUtils.setNumOfGameStagesRoundsCurrentlyPlayed
                        (
                                this.myTitForTatForFixedNumRoundsStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() + 1
                        );
     ...
     *
     * @param myTitForTatForFixedNumRoundsStrategy the Tit For Tat Strategy I'm currently using, with my moves
     *
    ...
    private void computeTitForTatStrategy
            (
                    List<GameNode> listOfOpponentLastMovesAsPlayer1,
                    List<GameNode> listOfOpponentLastMovesAsPlayer2,
                    PlayStrategy myTitForTatForFixedNumRoundsStrategy
            )
            throws GameNodeDoesNotExistException
    {
        ...
        if(gainFromDefect > deterministicLossFromDefect) {
            ...
            myTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
            myTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
            ...
            myTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
            myTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
        ...
        // so can be more benefit to, maybe, play a Cooperate Move, acting as both, Players #1 and #2
            ...
            for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                    ...
                    if( ( this.myTitForTatForFixedNumRoundsStrategyCommonUtils
                            ...
                            ( this.myTitForTatForFixedNumRoundsStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() == 1 ) )
                    {
                        ...
                        this.myTitForTatForFixedNumRoundsStrategyCommonUtils.setMyOpponentMovePlayedInLastGameStageRoundAsPlayer1
                                (
                    ...
                    if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        myTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                        myTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                    ...
                    if( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myTitForTatForFixedNumRoundsStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                        myTitForTatForFixedNumRoundsStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
