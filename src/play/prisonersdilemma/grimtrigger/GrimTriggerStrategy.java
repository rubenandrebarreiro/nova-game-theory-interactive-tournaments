...
public class GrimTriggerStrategy extends Strategy {
    ...
    /**
     * Executes the Grim Trigger Strategy, for the current Game being played.
     *
    ...
    /**
     * Computes the Grim Trigger Strategy, for the current Game, being played.
     *
     ...
     *
     * @param myGrimTriggerStrategy the Grim Trigger Strategy I'm currently using, with my moves
     *
     ...
     */
    private void computeGrimTriggerStrategy
    (
            List<GameNode> listOfOpponentLastMovesAsPlayer1,
            List<GameNode> listOfOpponentLastMovesAsPlayer2,
            PlayStrategy myGrimTriggerStrategy
    )
        ...
        for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
            ...
            if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                ...
                if( this.myGrimTriggerStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer1() ) {
                    ...
                    myGrimTriggerStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
                    myGrimTriggerStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
                ...
                // I am gonna Cooperate with him
                    ...
                    if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myGrimTriggerStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                        myGrimTriggerStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
            ...
            if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                ...
                if( this.myGrimTriggerStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer2() ) {
                    ...
                    // Setting My Strategy, accordingly to the previously mentioned description
                    myGrimTriggerStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
                    myGrimTriggerStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
                ...
                // I am gonna Cooperate with him
                    ...
                    if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                        ...
                        // Setting My Strategy, accordingly to the previously mentioned description
                        myGrimTriggerStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                        myGrimTriggerStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
