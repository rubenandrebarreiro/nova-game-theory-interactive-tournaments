 ...
 *
 * Omega Tit For Tat Strategy, for Fixed Number of Rounds with Probability
 *
 * Authors:
...
public class OmegaTitForTatForFixedNumRoundsWithProbabilityStrategy extends Strategy {
     ...
     */
    private OmegaTitForTatStrategyCommonUtils myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils;
    ...
    public void execute() throws InterruptedException {
        ...
        // The boolean value to keep information about if
        // the Omega Tit For Tat Strategy's Common Utils, it was initialized or not
        boolean isMyOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtilsInitialized = false;
        ...
        while(true) {
            ...
            PlayStrategy myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy = this.getStrategyRequest();

            // The Strategy chosen by me become NULL,
            // what means (probably) that the Game
            // was terminated by an outside event
            if (myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy == null) {
            ...
            if( !this.isMyOmegaTitForTatStrategyCommonUtilsInitialized ) {
                ...
                this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils =
                        new OmegaTitForTatStrategyCommonUtils(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy);

                this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.setupOmegaTitForTatStrategyParametersConfiguration();

                this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.printOmegaTitForTatStrategyParametersConfiguration();
            ...
            while( !playComplete ) {
                ...
                isATerminalGameNode
                        (
                                myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy,
                                this.tree.getNodeByIndex(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.getFinalP1Node()),
                                this.tree.getNodeByIndex(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.getFinalP2Node())
                        );
                ...
                Iterator<String> availableMovesLabels = myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.keyIterator();

                System.out.println("I will define My Strategy for the next Game Stage/Round...\n\n");

                finalGameNodePlayer1 = this.tree.getNodeByIndex(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.getFinalP1Node());
                finalGameNodePlayer2 = this.tree.getNodeByIndex(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.getFinalP2Node());
                ...
                if ((finalGameNodePlayer1 == null) || (finalGameNodePlayer2 == null)) {
                    ...
                    while ( currentValidationSetIterator.hasNext() ) {
                        ...
                        for (double availableMoveProbability : availableMovesProbabilities) {
                            ...
                            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(nextAvailableMovesLabel, availableMoveProbability);
                ...
                try {
                    ...
                    this.provideStrategy(myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy);
                ...
                this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.setNumOfGameStagesRoundsCurrentlyPlayed
                        (
                                this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() + 1
                        );
     ...
     *
     * @param myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy
     *        the Omega Tit For Tat Strategy For Fixed Num Rounds With Probability
    ...
    private void computeOmegaTitForTatStrategy
            (
                    List<GameNode> listOfOpponentLastMovesAsPlayer1,
                    List<GameNode> listOfOpponentLastMovesAsPlayer2,
                    PlayStrategy myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy
            )
            throws GameNodeDoesNotExistException
    {
                ...
                ( gainFromDefect > probabilisticLossFromDefect ) )
        {
            ...
            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_1, 0.0);
            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_1, 1.0);
            ...
            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_2, 0.0);
            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_2, 1.0);
        ...
        // so can be more benefit to, maybe, play a Cooperate Move, acting as both, Players #1 and #2
            ...
            for( String myOpponentMoveInLastGameStageRound : myOpponentMovesInLastGameStageRound ) {
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 1) {
                    ...
                    if( ( this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils
                            ...
                            ( this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() == 1 ) )
                    {
                        ...
                        this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.setMyOpponentMovePlayedInLastGameStageRoundAsPlayer1
                                (
                                        ...
                                        .equalsIgnoreCase( myOpponentMoveInLastGameStageRoundParts[2].toUpperCase() ) ) )
                        {
                            ...
                            this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.setTotalNumOfTimesMyOpponentMovesChangedAsPlayer1
                                    (
                                            this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils
                    ...
                    this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.checkIfMyOpponentIsBehavingRandomAsPayer1();
                    ...
                    if( this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer1() ) {
                    ...
                    // with a general and well known, Tit For Tat Strategy
                        ...
                        if ( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                            ...
                            // Setting My Strategy, accordingly to the previously mentioned description
                            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_2, 1.0);
                            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_2, 0.0);
                ...
                if(Integer.parseInt(myOpponentMoveInLastGameStageRoundParts[0]) == 2) {
                            ...
                            ( this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.getNumOfGameStagesRoundsCurrentlyPlayed() == 1 ) )
                    {
                                        ...
                                        .equalsIgnoreCase( myOpponentMoveInLastGameStageRoundParts[2].toUpperCase() ) ) )
                        {
                            ...
                            this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.setTotalNumOfTimesMyOpponentMovesChangedAsPlayer2
                                    (
                                            this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils
                    ...
                    this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.checkIfMyOpponentIsBehavingRandomAsPayer2();

                    // It seems that My Opponent behaved randomly as Player #2, until now,
                    // so I will act severely and I am gonna punish him always from now,
                    // with an All Defect Strategy, as Player #1
                    if( this.myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategyCommonUtils.isDefectingAsPunishmentToMyOpponentAsPlayer2() ) {
                    ...
                    // with a general and well known, Tit For Tat Strategy, as Player #1
                        ...
                        if( myOpponentMoveInLastGameStageRoundParts[2].equalsIgnoreCase(COOPERATE) ) {
                            ...
                            // Setting My Strategy, accordingly to the previously mentioned description
                            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(COOPERATE_AS_PLAYER_1, 1.0);
                            myOmegaTitForTatForFixedNumRoundsWithProbabilityStrategy.put(DEFECT_AS_PLAYER_1, 0.0);
